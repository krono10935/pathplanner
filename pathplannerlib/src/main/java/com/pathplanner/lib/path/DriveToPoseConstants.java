 ...
 * the static constants are the real constants that have default value.
 * the instanced constants are the pointers to DriveTrain.
 ...
 */
public record DriveToPoseConstants(Supplier<Pose2d> poseSupplier, Supplier<ChassisSpeeds> speedsSupplier,
                                   Consumer<ChassisSpeeds> drive, boolean useDriveToPose) {
    /**
     ...
     */
    public static ProfiledPIDController ANGULAR_PID_GAINS = new ProfiledPIDController(2, 0, 0, ANGLE_AUTO_CONSTRAINTS);
    /**
